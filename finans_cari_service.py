...
CARI_TURLERI = ('tedarikci', 'musteri', 'diger')
CARI_TUR_ETIKET = {'tedarikci': 'Tedarikçi', 'musteri': 'Müşteri', 'diger': 'Diğer'}
...
def _cari_hareket(cari: FinansCari, tur: str, tutar: Decimal, tarih: datetime, aciklama: str,
                  kullanici_id: int, islem_id=None, kalemler=None) -> FinansCariHareket:
