...
- July 01, 2025. Implemented automatic left margin adjustment for text elements. Added minimum 2mm left margin for all text elements (title, model_code, color, size, barcode) in all preview and print functions. Prevents text from appearing too close to label edge while preserving QR code and image positioning. Applied consistently across preview and A4 print functions for uniform text positioning
