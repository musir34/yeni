...
- July 03, 2025. Reverted Enhanced Product Label coordinate system back to original morning state. Restored proper A4 centering algorithm that calculates optimal label positioning using content dimensions and available space. System now uses same centering logic as Product Label for consistent A4 layout behavior
