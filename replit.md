...
- July 01, 2025. Reverted all complex coordinate system changes per user request. Removed detailed QR code scaling calculations, automatic position adjustments, and complex mm conversion systems. QR code processing returned to simple approach using basic size and position parameters without coordinate transformation. System now uses original simple implementation without advanced positioning features
