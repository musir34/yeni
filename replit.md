...
- July 01, 2025. Implemented automatic QR code positioning system in advanced label editor. QR codes now automatically position 15mm outside the right edge of label design with canvas extension for proper preview generation. Both frontend editor and backend preview functions support extended label width for QR codes positioned outside standard label boundaries
