...
- [[_mk_hazirlaniyor()]] - `calls` [EXTRACTED]
- [[_mk_order()]] - `calls` [EXTRACTED]
...
- [[_prep_model()]] - `indirect_call` [INFERRED]
- [[_prep_model()_1]] - `indirect_call` [INFERRED]
- [[_process_sync_orders_bulk()]] - `indirect_call` [INFERRED]
- [[_status_counts_now()]] - `indirect_call` [INFERRED]
- [[add_orders_hazirlaniyor_table.py]] - `imports` [EXTRACTED]
